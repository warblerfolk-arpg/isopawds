...
charadex.site = {
  ...
  description: `An isopod themed original species and ARPG.`
}
...
charadex.sheet = {
  ...
  id: "1e2qUK2Lqj6YcTwoWBip0gvdXBhRa7lU4nQjTF2Cg1M0",
  ...
  options: {
    ...
    rarity: ['All', 'Common', 'Uncommon', 'Rare', 'Legendary', 'Mythical', 'Mutation'],
    species: ['All', 'Isopawd'],
